    ...
    return GetBuilder<CartController>(builder: (cartController) {
      ...
      return cartQty != 0 ? Center(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            InkWell(
              ...
              child: Container(
                ...
                child: Icon(
                  Icons.remove, size: 16, color: Theme.of(context).textTheme.bodyMedium!.color,
                ),
              ),
            ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                child: Icon(
                  Icons.add, size: 16, color: Theme.of(context).textTheme.bodyMedium!.color,
                ),
              ),
            ),
          ]),
        ...
        child: child ?? Container(
          ...
          child: Icon(Icons.add, size: 20, color: Theme.of(context).textTheme.bodyMedium?.color),
        ),
      );
    });
  }
