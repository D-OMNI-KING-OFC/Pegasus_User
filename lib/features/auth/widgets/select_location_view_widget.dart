            ...
            widget.fromView ? Positioned(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.fullscreen, color: Theme.of(context).textTheme.bodyMedium?.color, size: 20),
                ),
              ),
            ) : const SizedBox(),
            ...
            Positioned(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.my_location_outlined, color: Theme.of(context).textTheme.bodyMedium?.color, size: widget.fromView ? 20 : 25),
                ),
              ),
            ),
